<template>
    <div id="toolbar">
        ...
        <div class="actions">
            <router-link v-if="['team','clients'].includes($store.state.route.view)" tag="button" class="big primary button" :to="{name: this.$store.state.route.view + '-new-project'}">+ New Project</router-link>
        </div>
    </div>
</template>
